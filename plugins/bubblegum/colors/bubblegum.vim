...
" (see `:h w18`)
"
hi Normal          ctermfg=253    ctermbg=233    cterm=none    guifg=#D4D7D6    guibg=#151718
hi Comment         ctermfg=244    guifg=#41535B

" yellow #E8D069
hi Constant        ctermfg=186    guifg=#E8D069
hi Character       ctermfg=187    guifg=#E8D069
hi Function        ctermfg=182    guifg=#E8D069
hi Typedef         ctermfg=146    guifg=#E8D069

" pink

" blue #4CB5DC
hi String          ctermfg=187    guifg=#4CB5DC
hi Statement       ctermfg=110    guifg=#4CB5DC
hi Conditional     ctermfg=110    guifg=#4CB5DC
hi Repeat          ctermfg=110    guifg=#4CB5DC
hi Label           ctermfg=110    guifg=#4CB5DC
hi Keyword         ctermfg=110    guifg=#4CB5DC
hi Exception       ctermfg=110    guifg=#4CB5DC

" green #9FCA56
hi Operator        ctermfg=110    guifg=#9FCA56
hi PreProc         ctermfg=150    guifg=#9FCA56
hi Include         ctermfg=150    guifg=#9FCA56
hi Define          ctermfg=150    guifg=#9FCA56
hi Macro           ctermfg=150    guifg=#9FCA56
hi PreCondit       ctermfg=150    guifg=#9FCA56
hi Identifier      ctermfg=182    guifg=#9FCA56
...
" red #CD3F45
hi Special         ctermfg=174    guifg=#CD3F45
hi SpecialChar     ctermfg=174    guifg=#CD3F45
hi Tag             ctermfg=174    guifg=#CD3F45
hi Delimiter       ctermfg=174    guifg=#CD3F45
hi SpecialComment  ctermfg=174    guifg=#CD3F45
hi Debug           ctermfg=174    guifg=#CD3F45
hi Number          ctermfg=179    guifg=#CD3F45
hi Boolean         ctermfg=187    guifg=#CD3F45
hi Float           ctermfg=179    guifg=#CD3F45
...
hi LineNr          ctermfg=244    ctermbg=237    guifg=#404B53    guibg=#0E1112
...
hi CursorLine      ctermbg=237    cterm=none    guibg=#101112    gui=none
hi CursorLineNr    guifg=#9FCA56 gui=bold
