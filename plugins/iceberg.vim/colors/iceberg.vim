...
hi! Cursor ctermbg=252 ctermfg=Black guibg=#c6c8d1 guifg=#161821
hi! CursorLineNr ctermbg=237 ctermfg=253 guibg=#2a3158 guifg=#cdd1e6
hi! Delimiter ctermfg=252 guifg=#c6c8d1
hi! DiffAdd ctermbg=108 ctermfg=Black guibg=#555a47 guifg=#bec4b1
hi! DiffChange ctermbg=66 ctermfg=Black guibg=#445861 guifg=#adc1cb
hi! DiffDelete ctermbg=95 ctermfg=Black guibg=#673e43 guifg=#d1a8ad
hi! DiffText cterm=NONE ctermbg=116 ctermfg=Black gui=NONE guibg=#89b8c2 guifg=#161821
hi! Directory ctermfg=109 guifg=#89b8c2
hi! Error ctermbg=Black ctermfg=203 guibg=#161821 guifg=#e27878
hi! ErrorMsg ctermbg=Black ctermfg=203 guibg=#161821 guifg=#e27878
hi! WarningMsg ctermbg=Black ctermfg=203 guibg=#161821 guifg=#e27878
...
hi! NonText ctermbg=Black ctermfg=236 guibg=#161821 guifg=#242940
hi! SpecialKey ctermbg=Black ctermfg=236 guibg=#161821 guifg=#242940
hi! Normal ctermbg=Black ctermfg=252 guibg=#161821 guifg=#c6c8d1
...
hi! Search ctermbg=216 ctermfg=Black guibg=#e4aa80 guifg=#392313
...
hi! StatusLine cterm=reverse ctermbg=Black ctermfg=245 gui=reverse guibg=#17171b guifg=#818596 term=reverse
...
hi! TabLine cterm=NONE ctermbg=245 ctermfg=Black gui=NONE guibg=#818596 guifg=#17171b
hi! TabLineFill cterm=reverse ctermbg=Black ctermfg=245 gui=reverse guibg=#17171b guifg=#818596
hi! TabLineSel cterm=NONE ctermbg=Black ctermfg=252 gui=NONE guibg=#161821 guifg=#9a9ca5
hi! Title ctermfg=216 gui=NONE guifg=#e2a478
hi! Todo ctermbg=Black ctermfg=150 guibg=#161821 guifg=#d8e599
...
hi! WildMenu ctermbg=255 ctermfg=Black guibg=#d4d5db guifg=#17171b
